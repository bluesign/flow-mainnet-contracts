...
pub contract appstoretest5_NFT: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.Editions>():
                    ...
                    let editionName = appstoretest5_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: appstoretest5_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
        ...
        pub fun getMimeType(): String {
            var metadataFileType = appstoretest5_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!.toLower()
