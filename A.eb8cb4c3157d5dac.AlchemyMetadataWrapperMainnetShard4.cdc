        ...
        for key in ids.keys {
            for id in ids[key]! {
                ...
                switch key {
                    ...
                    case "Flovatar": d = self.getFlovatarNFT(owner: owner, id: id)
                    case "FlovatarComponent": d = self.getFlovatarComponentNFT(owner: owner, id: id)
                    case "ByteNextMedalNFT": d = self.getByteNextMedalNFT(owner: owner, id: id)
